...
struct CoachView: View {
    ...
    private var privacyDescription: String {
        switch coach.provider {
        case .custom:
            return "Coach talks only to the server URL you set — point it at a local model (Ollama, LM Studio, llama.cpp) to keep everything on your own machine. Nothing leaves \(Platform.deviceNounPhrase) until you ask."
        case .codexLocal:
